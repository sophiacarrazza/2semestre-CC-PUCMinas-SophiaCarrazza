#include <stdlib.h>
    ...
    // aloca espa�o para o novo jogador
    ...
    void swap (Jogador array[], int p1, int p2){
            Jogador temp = array[p1];
            array[p1] = array[p2];
            array[p2] = temp;
    ...
    void ListadeJogadores(Jogador array[], int *n) {
       ...
       //FILE *arq = fopen(".\\tmp\\players.csv", "r");
        ...
        for (int i = 0; i < num_ins_rem; i++) {
            ...
            }else if (strcmp(a, "RF") == 0){
                    Jogador removido = removerFim(array, n);
                    printf("(R) %s\n", removido.nome);
            }
    ...
    int main()
    {
        ...
        //free(*array);  // Liberar a memoria alocada para o array.
        //free(array);
        return 0;
    }
